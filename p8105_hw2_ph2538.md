...
```
    ...
    ##  9 September        4.53      2016       NA           NA
    ## 10 October          0.62      2016       NA           NA
    ## 11 November         1.47      2016       NA           NA
    ## 12 December         2.32      2016       NA           NA
...
For trash wheel data, the dimension of the dataset (exluding NA) is 216,
14 which shows that there are 216 observations. Some key variables
include weight (in tons), plastic bottles, and number of homes powered.
The total weight tons collected from 2014 to 2017 is 1408.88, total
number of plastic bottles collected is 9.27210^{5}, and total number of
homes powered is 1.621810^{4}. The median number of sports balls in a
dumpster in 2016 is 26

For precipitation data, the number of observations in 2016 was 12 and
the number of observations in 2017 was 8. This means that for 2016,
there is precipitation data for all 12 months of the year, but for 2017,
there is only data for the first eight months of the year (January to
August). The total precipitation in 2017 is 29.93.
