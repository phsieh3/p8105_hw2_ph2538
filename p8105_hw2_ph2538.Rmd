...
# clean_brfss %>%
#   mutate(exc_proportion = Excellent / 
#   sum(Excellent:clean_brfss$'Very good'))
#   filter(state == "NY ") %>%
...
#   sum(clean_brfss$Excellent:clean_brfss$'Very good')
# 
# brfss_NY_Queens = filter(clean_brfss, county == "New York County", county == "Queens County")
# brfss_NY = filter(clean_brfss, state == "NY ")
# brfss_NYC_Queens = filter(brfss_NY, county == " New York County", county == " Queens County")
# brfss_NYC_Queens = filter(clean_brfss, state == "NY ", county == " New York County", county == " Queens County")
# 
# ggplot(clean_brfss, aes(x = Year, y = exc_proportion)) + geom_point()
